 ...
 * properties (with 'axon-metadata-' prefix) to the message. Other
 * message-specific attributes are also added as properties. The message payload
 * is serialized using the configured serializer and passed as the message body.
 *
...
public class DefaultJmsMessageConverter implements JmsMessageConverter {
    ...
    /**
     * Initializes the JmsMessageConverter with the given {@code serializer} and
     * requesting persistent dispatching.
     *
     * @param serializer The serializer to serialize the Event Message's payload
     * with
     */
    ...
    /**
     * Initializes the JmsMessageConverter with the given {@code serializer} and
     * requesting persistent dispatching when {@code persistent} is
     * {@code true}.
     *
     * @param serializer The serializer to serialize the Event Message's payload
     * and Meta Data with
